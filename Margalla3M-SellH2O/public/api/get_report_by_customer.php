...
// Same figures/size-bucketing/flat-rate Profit model as
// get_report_by_region.php, grouped by Customer instead of Region. Grouped
// by Customer_id (not just name) so two different customers can never
// collapse into one row even if they somehow shared a display name;
// walk-in / no-customer sales (Customer_id IS NULL) are grouped together as
// their own row rather than dropped.
$sql = "SELECT
