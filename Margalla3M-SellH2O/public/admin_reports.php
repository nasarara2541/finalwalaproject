...
// Shared pivot: turns flat {RowKey, RowLabel, Size, Sale, Cost} rows for one
// month into [{label, sizeProfit:{'0.5L':n,...}, total}], sorted by total
// profit descending -- Region and Customer reports share this exact shape.
