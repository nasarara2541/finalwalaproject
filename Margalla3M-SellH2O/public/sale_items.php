...
<div class="win-titlebar">
    <span>&#x1F4A7; AISellProduct &mdash; Sale Items</span>
...
<div class="win-menubar">
    ...
    <span class="win-menu-item nav-active">Sale Items</span>
    ...
    <span class="win-menu-item" onclick="window.location='login.php'">&#x1F504; Switch Database</span>
    <span class="win-menu-item" style="color:#555;">User: <b><?php echo htmlspecialchars($_SESSION['emp_user_name'] ?? '—'); ?></b></span>
    <span class="win-menu-item" onclick="window.location='logout.php'" style="color:darkred;">&#x1F6AA; Logout</span>
</div>
...
<div style="display:flex;flex-direction:column;flex:1;padding:5px;gap:4px;min-height:0;">
    ...
    <div style="display:flex;gap:4px;">
        ...
        <button class="win-btn toolbar-btn" disabled title="Voiding an already-saved bill needs a status column on [Transaction] that doesn't exist yet (trans_detail.Status exists but is unused/undefined) — not wired up yet, noted for follow-up.">Cancellation</button>
                ...
                <div class="win-scroll" style="flex:1;">
                    <table class="win-table">
                        <thead><tr>
                            ...
                            <th title="No matching column — you said skip this for now, waiting on your professor">Generic</th>
...
function clearSaleForm() {
    cart = []; selectedItem = null; editingTransNo = null;
